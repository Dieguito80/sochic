...
<div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    ...
    <div class="rounded-2xl shadow-lg max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
        
        <!-- Contenedor del QR con alias y pasos -->
        <div class="w-full md:w-1/3 flex flex-col items-center bg-gray-100 p-6 rounded-2xl">
            ...
            <!-- Pasos debajo del QR en columna -->
        ...
        <div class="w-full md:w-2/3 bg-white p-8 rounded-2xl">
            ...
            <div class="mb-6 text-left">
                <a 
                    href="{{ url()->previous() }}" 
                    class="inline-block px-3 py-1 bg-gray-500 text-white font-medium text-xs rounded-lg shadow-md hover:bg-gray-600 transition">
                    Volver
                </a>
            </div>
